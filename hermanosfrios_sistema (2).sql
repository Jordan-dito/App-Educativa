...
-- Generation Time: Oct 29, 2025 at 10:53 PM
...
INSERT INTO `asistencia` (`id`, `materia_id`, `estudiante_id`, `fecha_clase`, `estado`, `profesor_id`, `fecha_registro`) VALUES
(1, 5, 16, '2025-10-29', 'presente', 5, '2025-10-29 16:50:00'),
(2, 5, 19, '2025-10-29', 'presente', 5, '2025-10-29 16:50:00'),
(3, 5, 20, '2025-10-29', 'ausente', 5, '2025-10-29 16:50:00'),
(12, 3, 15, '2025-10-29', 'presente', 7, '2025-10-29 17:26:39'),
(13, 3, 16, '2025-10-29', 'presente', 7, '2025-10-29 17:26:39');
...
(3, 3, '2025', '2025-10-29', '2026-02-26', 'lunes,martes,miercoles,jueves', '08:00:00', 80.00, 'activo', '2025-10-29 16:32:44');
...
(21, 30, 'laura', 'looez', '10°', 'C', '13868831', 'tv83', '2015-11-01', 'activo', '2025-10-29 17:53:28', '2025-10-29 17:53:28'),
(22, 31, 'hwbeej', 'dbdj', '6°', 'D', '12345678', 'transversal', '2015-11-01', 'activo', '2025-10-29 17:54:05', '2025-10-29 17:54:05');
...
(3, 'programación', '2°', 'A', 7, '2024', 'activo', '2025-10-07 01:51:01', '2025-10-29 16:18:50'),
...
(10, 'gastonomia', '1°', 'A', 1, '2025', 'activo', '2025-10-25 17:36:44', '2025-10-29 18:02:20'),
...
(13, 'hola', '9°', 'C', 8, '2025', 'activo', '2025-10-29 18:06:56', '2025-10-29 18:06:56');
...
INSERT INTO `notas` (`id`, `estudiante_id`, `materia_id`, `profesor_id`, `año_academico`, `nota_1`, `nota_2`, `nota_3`, `nota_4`, `promedio`, `estado`, `fecha_registro`, `fecha_actualizacion`) VALUES
(1, 16, 5, 5, '2025', 85.00, 90.00, 88.00, 92.00, 88.75, 'activo', '2025-10-29 21:01:38', '2025-10-29 21:01:38'),
(2, 19, 5, 5, '2025', 75.00, 80.00, 78.00, NULL, 77.67, 'activo', '2025-10-29 21:01:38', '2025-10-29 21:01:38'),
(3, 20, 6, 5, '2025', 95.00, 88.00, 92.00, 90.00, 91.25, 'activo', '2025-10-29 21:01:38', '2025-10-29 21:01:38'),
(4, 10, 10, 1, '2025', 50.00, 60.00, 80.00, 40.00, 57.50, 'activo', '2025-10-29 21:24:04', '2025-10-29 21:24:04'),
(7, 15, 3, 7, '2025', 50.00, 52.00, 80.00, 50.00, 58.00, 'activo', '2025-10-29 21:49:19', '2025-10-29 21:49:19');

--
-- Triggers `notas`
--
DELIMITER $$
CREATE TRIGGER `actualizar_promedio_notas` BEFORE UPDATE ON `notas` FOR EACH ROW BEGIN
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `calcular_promedio_notas` BEFORE INSERT ON `notas` FOR EACH ROW BEGIN
    DECLARE total_notas INT DEFAULT 0;
    DECLARE suma_notas DECIMAL(10,2) DEFAULT 0;
...
(9, 32, 'heebdj', 'sbeh', '18679452', 'brrurrb', '2025-10-29', 'activo', '2025-10-29 17:54:47', '2025-10-29 17:54:47'),
(10, 33, 'uwbeue', 't ktn', '15786905', 'ejejrb', '2025-10-29', 'activo', '2025-10-29 17:55:18', '2025-10-29 17:55:18');
...
(30, 'iswbdje@gmail.com', '$2y$10$CtUjaQOlbcgS.zXuW/Qzeei19rN61rDl/GNR.8qm83x.lNkBc5Q.O', 'estudiante', 'activo', '2025-10-29 17:53:28', '2025-10-29 17:53:28'),
(31, 'bsebeh@gmaum.com', '$2y$10$rHLDXnTFU7G5gmNYgzXytOnurEKLsMWJgVxiU7zSsNW7jCMSnzo0G', 'estudiante', 'activo', '2025-10-29 17:54:05', '2025-10-29 17:54:05'),
(32, 'sjwbd@gma.com', '$2y$10$LQQ8cRoACsTDbcM.LEqA/.8k8LJjAmzdc.8WK3zdXBuX.k7t3XJ0e', 'profesor', 'activo', '2025-10-29 17:54:47', '2025-10-29 17:54:47'),
(33, 'euebe@gmail.con', '$2y$10$C7Vlo4sJqMb5w/k.y2l37uFiCSpDSso7KMOtGX4fnFAYorjKKm5lO', 'profesor', 'activo', '2025-10-29 17:55:18', '2025-10-29 17:55:18');
...
ALTER TABLE `notas`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `estudiante_materia_año_unico` (`estudiante_id`,`materia_id`,`año_academico`),
  ADD KEY `idx_notas_estudiante` (`estudiante_id`),
...
ALTER TABLE `notas`
  ...
  ADD CONSTRAINT `notas_ibfk_3` FOREIGN KEY (`profesor_id`) REFERENCES `profesores` (`id`) ON DELETE CASCADE;
